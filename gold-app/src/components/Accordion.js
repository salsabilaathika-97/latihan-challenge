    ...
    return (
        <>
            ...
            <div className="mx-auto w-full max-w-md rounded-2xl bg-white p-2">
                ...
                {({ open }) => (
                    <>
                    <Disclosure.Button className="flex w-full justify-between rounded-lg bg-white px-4 py-2 text-left text-sm font-bold text-black border border-gray-600 w-[668px] h-14">
